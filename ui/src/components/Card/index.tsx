  ...
  return (
    <>
      ...
      >
        <button
          type="button"
          className="absolute right-4 text-gray-400 bg-transparent rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
          onClick={closeModal}
        >
          <svg
            className="w-5 h-5"
        ...
        <div className="flex flex-col justify-between py-6 ml-6">
          <button className="text-2xl" onClick={onBuy}>
            buy
          </button>
        </div>
      </Modal>
